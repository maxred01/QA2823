...
# auth-form__input auth-form__input_width_full"]""").send_keys('roma')
# driver.implicitly_wait(5)
# element_clear = driver.find_element(By.CSS_SELECTOR, """
# div>div>div>div>div>div>input[class="auth-input auth-input_primary auth-input_base
# auth-form__input auth-form__input_width_full"]""").clear()
# driver.implicitly_wait(5)
# element_get = driver.find_element(By.CSS_SELECTOR, """
# div>div>div>div>div>div>input[class="auth-input auth-input_primary auth-input_base
# auth-form__input auth-form__input_width_full"]""").get_attribute('placeholder')
# print(element_get)
# element_get = driver.find_element(By.CSS_SELECTOR, """
# div>div>div>div>div>div>input[class="auth-input auth-input_primary auth-input_base
# auth-form__input auth-form__input_width_full"]""").is_displayed()
...
time.sleep(2)
elements_basket = driver.find_elements(By.XPATH, """
//div[@class="domainsTable recom done"]
//button[@class="btnBorder redBtn small  toCart gmt-active-to-basket"]""")
