...
driver.implicitly_wait(5)
#
# driver.find_element(By.XPATH, '//input[@class="auth-input auth-input_primary auth-input_base auth-form__input '
#                               'auth-form__input_width_full"]').clear()
# driver.implicitly_wait(5)

# element = driver.find_element(By.XPATH, '//input[@class="auth-input auth-input_primary auth-input_base '
