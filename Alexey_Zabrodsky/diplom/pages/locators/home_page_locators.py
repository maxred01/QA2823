...
button_telegram = (By.CSS_SELECTOR, 'div.header div.block__phone__social__item.telegram svg')
...
number_velcom = (By.CSS_SELECTOR, 'div.header a#id__header_phone_velcom')
number_mts = (By.CSS_SELECTOR, 'div.header a#id__header_phone_mts')
number_city = (By.CSS_SELECTOR, 'div.header a#id__header_phone_city')
# <---header_mobile--->
...
button_vse_stati = (By.CSS_SELECTOR, 'div.main__left_side div.block__articles__read_more')
button_vse_novosti = (By.CSS_SELECTOR, 'div.main__left_side div.block__news__read_more')
# <---assert menu--->
...
nabory_posudy = (By.CSS_SELECTOR, '[title="Наборы посуды"]')
